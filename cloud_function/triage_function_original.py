...
#SEVERITY_ENDPOINT = f"https://us-central1-aiplatform.googleapis.com/v1/projects/{PROJECT}/locations/us-central1/endpoints/8775805933163905024:predict"
#SEVERITY_ENDPOINT = f"https://us-central1-aiplatform.googleapis.com/v1/projects/{PROJECT}/locations/us-central1/endpoints/8775805933163905024:predict"
#SEVERITY_ENDPOINT = f"projects/{PROJECT}/locations/{REGION}/endpoints/8775805933163905024"
#SEVERITY_ENDPOINT = "http://8775805933163905024.aiplatform.googleapis.com/v1/models/7574459737446547456:predict"
#SEVERITY_ENDPOINT = f"https://8775805933163905024.{REGION}-{PROJECT}.prediction.vertexai.goog/v1/projects/{PROJECT}/locations/{REGION}/endpoints/8775805933163905024:predict"
#SEVERITY_ENDPOINT = f"https://{REGION}-aiplatform.googleapis.com/v1/projects/{PROJECT}/locations/{REGION}/endpoints/8775805933163905024:predict"
#SEVERITY_ENDPOINT = "https://us-central1-aiplatform.googleapis.com/projects/506101299280/locations/us-central1/endpoints/8775805933163905024:predict"
    ...
    try:
        ...
        if not symptoms:
            ...
            prediction = severity_prediction_client.predict(
                ...
                instances=[{"mime_type": "text/plain","content": input_text}], # This is the most likely correct format for Gemini fine-tune
            )
