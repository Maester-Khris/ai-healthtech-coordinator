...
export default function SetupPage() {
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isMobile ? 'bg-gray-50' : 'bg-slate-100'}`}>
      ...
      <div className={isMobile ? 'contents' : 'flex-1 overflow-y-auto py-10 px-4'}>
        <div className={isMobile ? 'contents' : 'max-w-2xl mx-auto w-full bg-white rounded-2xl shadow-sm overflow-hidden'}>
          ...
          {/* Form content */}
          <div className={`px-5 py-5 flex flex-col gap-5 ${isMobile ? 'flex-1 overflow-y-auto' : ''}`}>
            {/* Location access */}
            <div>
