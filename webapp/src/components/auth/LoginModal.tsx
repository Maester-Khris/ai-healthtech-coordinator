    ...
    >
      ...
      >
        ...
        <div className="flex rounded-stratum-md bg-stratum-bg p-1 mb-6">
          <button
            className={`flex-1 py-2 text-sm font-semibold rounded-stratum-md transition-all ${tab === "signin"
          ...
          <button
            className={`flex-1 py-2 text-sm font-semibold rounded-stratum-md transition-all ${tab === "signup"
                ? "bg-white text-stratum-text shadow-sm"
                : "text-stratum-text-muted hover:text-stratum-text"
              }`}
